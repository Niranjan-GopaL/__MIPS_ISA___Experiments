...
main:
    ...
    init_loop:
        sw $t0, 0($a2)    # Store 0 in the next element of matrix C
    ...
    # Rest of the program (matrix multiplication) remains the same as before.
    # (You can copy the matrix multiplication part from the previous answer here.)
    ...
    # Outer loop (i-loop): Loop over rows of A
    outer_loop:
        ...
        middle_loop:
            ...
            li $t3, 0   # Initialize the accumulator to 0
